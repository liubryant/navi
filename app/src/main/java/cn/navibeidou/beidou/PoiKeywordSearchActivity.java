...
import cn.navibeidou.beidou.Util.AMapUtil;
import cn.navibeidou.beidou.Util.ToastUtil;
import cn.navibeidou.beidou.overlay.PoiOverlay;
...
public class PoiKeywordSearchActivity extends FragmentActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("liuzheng", "city  " + city + "  latitude  " + latitude + "  longitude  " + longitude);
        init();
    }
    ...
    private void setTitleBar() {
        if (android.os.Build.VERSION.SDK_INT >= 21) {
            ...
            window.setStatusBarColor(Color.parseColor("#95a5a6"));
        }
    }
}
